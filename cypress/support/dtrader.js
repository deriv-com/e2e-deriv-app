...
Cypress.Commands.add('c_compareElementScreenshots', (elementSelector, imageName1, imageName2, diffImageName) => {
  ...
  cy.readFile(`./cypress/e2e/wip/dtrader/${imageName1}_${timestamp}.png`, 'base64').then((img1Data) => {
    cy.readFile(`./cypress/e2e/wip/dtrader/${imageName2}_${timestamp}.png`, 'base64').then((img2Data) => {
      ...
      cy.writeFile(`./cypress/e2e/wip/dtrader/${diffImageName}_${timestamp}.png`, PNG.sync.write(diff), 'base64')
