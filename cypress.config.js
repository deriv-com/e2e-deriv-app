...
module.exports = defineConfig({
  ...
  env: {
    ...
    walletsLoginEmail: process.env.WALLETS_LOGIN,
    walletsLoginPassword: process.env.WALLETS_PASSWORD,
    doughflowLoginEmail:  process.env.DOUGHFLOW_LOGIN,
    doughflowLoginPassword: process.env.DOUGHFLOW_PASSWORD,
    ...
    fiatOnrampAppId: process.env.FIAT_ONRAMP_APPID,
    doughflowConfigServer: process.env.DOUGHFLOW_CONFIG_SERVER,
    doughflowConfigAppId: process.env.DOUGHFLOW_CONFIG_APPID,
    oAuthUrl: process.env.E2E_OAUTH_URL,
    oAuthToken: process.env.E2E_OAUTH_TOKEN,
    doughflowOAuthUrl: process.env.DOUGHFLOW_OAUTH_URL,
    doughflowOAuthToken: process.env.DOUGHFLOW_OAUTH_TOKEN,
