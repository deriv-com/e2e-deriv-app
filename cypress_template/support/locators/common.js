export const commonPageLocators = {
  ...
  footer: {
    serverEndpointStatus: (serverEndpoint) =>
      cy.findByText(`The server endpoint is: ${serverEndpoint.toLowerCase()}`),
    ...
    responsibleTradingRedirectBtn: () =>
      cy.get('a[href="https://deriv.com/responsible"]'),
