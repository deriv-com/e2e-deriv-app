import './cashier'
import { getOAuthUrl } from '../utility'
...
Cypress.Commands.add('c_clickToOpenInSamePage', { prevSubject: true }, (locator) => {
...
Cypress.Commands.add("c_visitResponsive", (path, size) => {
    ...
    if (path.includes("region")) {
        ...
        cy.findByRole("button", { name: "whatsapp icon", timeout: 30000 }).should("be.visible") //For the home page, this seems to be the best indicator that a page has fully loaded. It may change in the future.
    }
